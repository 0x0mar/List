...
maligno	1.0	An open source penetration testing tool written in python, that serves Metasploit payloads. It generates shellcode with msfvenom and transmits it over HTTP or HTTPS.	http://www.encripto.no/tools/
...
scout2	126.56ba857	Security auditing tool for AWS environments.	http://isecpartners.github.io/Scout2/
...
sees	11.bcc243d	Increase the success rate of phishing attacks by sending emails to company users as if they are coming from the very same company's domain.	https://github.com/galkan/sees/
...
set	6.0.4	Social-engineer toolkit. Aimed at penetration testing around Social-Engineering	https://www.trustedsec.com/downloads/social-engineer-toolkit
...
siege	3.0.5	An http regression testing and benchmarking utility	http://www.joedog.org/JoeDog/Siege
...
smbexec	124.bf106c0	A rapid psexec style attack with samba tools.	https://github.com/pentestgeek/smbexec
...
snoopy-ng	90.64f854c	A distributed, sensor, data collection, interception, analysis, and visualization framework.	https://github.com/sensepost/snoopy-ng
...
spipscan	7971.afe413d	SPIP (CMS) scanner for penetration testing purpose written in Python.	https://github.com/PaulSec/SPIPScan
...
sploitego	151.36fa214	Maltego Penetration Testing Transforms.	https://github.com/allfro/sploitego
...
sslcaudit	519.6967cc6	Utility to perform security audits of SSL/TLS clients.	https://github.com/grwl/sslcaudit
...
sslsplit	0.4.8	A tool for man-in-the-middle attacks against SSL/TLS encrypted network connections	http://www.roe.ch/SSLsplit
...
sslyze	0.9	Python tool for analyzing the configuration of SSL servers and for identifying misconfigurations.	https://github.com/iSECPartners/sslyze
...
statsprocessor	0.082	A high-performance word-generator based on per-position Markov-attack	http://hashcat.net/wiki/doku.php?id=statsprocessor
...
stunnel	5.02	A program that allows you to encrypt arbitrary TCP connections inside SSL	http://www.stunnel.org
...
sulley	1.0.afcd647	A pure-python fully automated and unattended fuzzing framework	https://github.com/OpenRCE/sulley/
superscan	4	Powerful TCP port scanner, pinger, resolver.	http://www.foundstone.com/us/resources/proddesc/superscan.htm
suricata	2.0.1	An Open Source Next Generation Intrusion Detection and Prevention Engine.	http://openinfosecfoundation.org/index.php/download-suricata
...
sysdig	865.0121b43	Open source system-level exploration and troubleshooting tool.	http://www.sysdig.org/
sysinternals-suite	1.1	Sysinternals tools suite.	http://sysinternals.com
...
tcpdump	4.5.1	A tool for network monitoring and data acquisition	http://www.tcpdump.org
...
tcpreplay	3.4.4	Gives the ability to replay previously captured traffic in a libpcap format	http://tcpreplay.synfin.net
...
tekdefense-automater	36.922b6a0	IP URL and MD5 OSINT Analysis	https://github.com/1aN0rmus/TekDefense-Automater
...
tor	0.2.4.22	Anonymizing overlay network.	http://www.torproject.org/
...
torsocks	1.3	Wrapper to safely torify applications	http://code.google.com/p/torsocks
...
traceroute	2.0.19	Tracks the route taken by packets over an IP network	http://traceroute.sourceforge.net/
trid	2.11	An utility designed to identify file types from their binary signatures	http://mark0.net/soft-trid-e.html
trinity	3427.d89b58e	A Linux System call fuzzer.	http://codemonkey.org.uk/projects/trinity/
...
uefi-firmware-parser	81.7f018f2	Parse BIOS/Intel ME/UEFI firmware related structures: Volumes, FileSystems, Files, etc	https://github.com/theopolis/uefi-firmware-parser
...
umap	20.34230e6	The USB host security assessment tool.	https://github.com/nccgroup/umap
...
veil	211.25dc22c	A tool designed to generate metasploit payloads that bypass common anti-virus solutions.	https://github.com/veil-evasion/Veil
...
viper	279.aea7102	A Binary analysis framework.	https://github.com/botherder/viper
...
websploit	2.0.5	An Open Source Project For, Social Engineering Works, Scan, Crawler & Analysis Web, Automatic Exploiter, Support Network Attacks	http://code.google.com/p/websploit/
...
wig	149.f43cc8c	WebApp Information Gatherer.	https://github.com/jekyc/wig
...
wireshark-cli	1.10.8	a free network protocol analyzer for Unix/Linux and Windows - CLI version	http://www.wireshark.org/
wireshark-gtk	1.10.8	a free network protocol analyzer for Unix/Linux and Windows - GTK frontend	http://www.wireshark.org/
...
wordpot	34.bbaf582	A Wordpress Honeypot.	https://github.com/gbrindisi/wordpot
wpbf	7.11b6ac1	Multithreaded WordPress brute forcer.	https://github.com/dejanlevaja/wpbf
wpscan	1585.aececf9	A vulnerability scanner which checks the security of WordPress installations using a black box approach.	http://wpscan.org
...
xssless	34.d474fc6	An automated XSS payload generator written in python.	https://github.com/mandatoryprogrammer/xssless
...
zmap	1.2.0	Fast network scanner designed for Internet-wide network surveys.	https://zmap.io/
